...
<body style="background-color: ">
  <?php 
   ...
   <div class="card-header">
                <h3 class="card-title">Add Volunteers </h3>
              </div> 
...
<section class="content">
  ...
  <div>
    <form action="add_volunteer_proc.php" method="post">
  ...
  <div class="form-row">
   ...
   <div class="form-row">
    ...
    <label>Education</label>
      <input type="text" name="educ"  class="form-control" placeholder="Education" required="">
    </div>
    <div class="col">
    <label>skills</label>
