<?php 
 ...
 <?php
				...
				$id = $_GET['id']; 
				$form_location = base_url()."delete_director.php?id=".$id; 
			?>
  <div class="card">
            <div class="card-header">
              <h3 class="card-title">Delete Director</h3>
            </div><br><br><br><br>
 <div class="container">
  <div class="card card-info">
              ...
              <form class="form-horizontal" action="<?=$form_location?>" method="post">
                ...
                <i class="btn btn-secondary float-right" style=""><a href="directors_view.php">Cancel</a></i>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
