...
<div class="  container">
 ...
 <section class="content-header">
    ...
    <a href="add_directors.php"><i class="btn btn-primary">Add Director</i></a>
</section>
   ...
   <td class="center span2">
 	 	...
 	 	<td>
			...
			<a href="edit_director.php?id=<?= $id ?>">
				<i class="fas fa-edit" style="color: blue"></i>
			</a>
			&nbsp
			<a href="director_confirmdelete.php?id=<?= $id ?>">
			<i class=" fas fa-trash-alt" style="color: red" >  </i>
			</a>
			&nbsp
			
			<a href="director_profile.php?id=<?= $id ?>" >
