...
<?php 
	...
	$id = $_GET['id'];
	$form_edit="staff_edit_proc.php?id=".$id;
  ...
  <div class="row-fluid sortable">
    <div class="box span12">
      ...
      <div class="box-content">
        ...
        if ($photo == ""){
        ?>
        <a href="<?= base_url() ?>staff_uploadphoto.php?id=<?= $id ?>">
        ...
        <br><br>
        <a href="<?= base_url() ?>staff_deletephoto.php?id=<?= $id ?>">
...
<label>Account Type</label>
  ...
  <select name="account_type" class="custom-select" id="inputGroupSelect01" required=" tanginamo"  value="<?=$account_type?>">
