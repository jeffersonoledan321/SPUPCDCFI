...
<div class="  container">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <a href="index.php"><i class="btn btn-primary">Add Children</i></a>
</section>
    ...
    <td><?=$qraddress?></td>
            ...
            <td><a href=""><button class="btn btn-secondary">Attendance</button></a></td>

 	 	<td>

 	 		
			<a href="edit_children.php?id=<?= $id ?>">
			...
			<a href="children_profile.php?id=<?= $id ?>" >
