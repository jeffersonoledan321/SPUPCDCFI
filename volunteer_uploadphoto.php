...
?>
 <div class="card-header">
                <h3 class="card-title">Upload Volunteer Photo</h3>
              </div> 
<br><br>
...
<div class="container">
  <div class="card card-info">
			...
			<form method="post" action="volunteer_uploadphoto_proc.php?id=<?= $id ?>" enctype="multipart/form-data">
			<p style="margin-top:24px;">
			  ...
			  <fieldset>
                ...
                <div class="card-footer">
                  ...
                  <i class="btn btn-danger" style="float: right"><a href="volunteer_view.php" style="color: black"> Cancel</a></i>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
